...
PI_comport = 'COM4'
Manip1_comport = 'COM3'  # small stage ?
Manip2_comport = 'COM5'  # big stage ?
...
class AppRoot(TabularMeasurements2M):
    ...
    def __init__(self, objectName=None, loop=None):
        ...
        manipulator2 = PI.AxisAtController(self.mani_conn2)
        ...
        self.dataSaver.registerManipulator(self.manipulator1, 'Position smallStage')
        self.dataSaver.registerManipulator(self.manipulator2, 'Position bigStage')
